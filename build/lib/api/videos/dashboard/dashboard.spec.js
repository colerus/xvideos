...
describe('api/videos/dashboard', function () {
    it('should list dashboard video pages', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should fail when page parameter is less than 0', function () { return __awaiter(void 0, void 0, void 0, function () {
        var err, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
